...
const projects: projectsType[] = [
  ...
  },
  {
    ...
    type: "group",
    description: "A spiritual successor to Classroom Seating Planner, Table Placement Optimiser aims to be a general purpose tool to generate seating arrangements in a wide range of applications. With its innovative system of 'wildcards' it allows for only a small amount of constraints to be used for most situations.",
